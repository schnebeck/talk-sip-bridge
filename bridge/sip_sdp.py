# talk-sip-bridge - bridge/sip_sdp.py
# SDP for the codecs this bridge implements: building an offer or an answer,
# and reading back what the far end offered or answered.
#
